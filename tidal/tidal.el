...
(defun tidal-mode-keybindings (map)
  ...
  (define-key map [?\C-x ?\C-1] 'tidal-stop-d1)
  (define-key map [?\C-x ?\C-2] 'tidal-stop-d2)
  (define-key map [?\C-x ?\C-3] 'tidal-stop-d3)
  (define-key map [?\C-x ?\C-4] 'tidal-stop-d4)
  (define-key map [?\C-x ?\C-5] 'tidal-stop-d5)
  (define-key map [?\C-x ?\C-6] 'tidal-stop-d6)
  (define-key map [?\C-x ?\C-7] 'tidal-stop-d7)
  (define-key map [?\C-x ?\C-8] 'tidal-stop-d8)
  (define-key map [?\C-x ?\C-9] 'tidal-stop-d9))
...
(defun turn-on-tidal-keybindings ()
  ...
  (local-set-key [?\C-x ?\C-1] 'tidal-stop-d1)
  (local-set-key [?\C-x ?\C-2] 'tidal-stop-d2)
  (local-set-key [?\C-x ?\C-3] 'tidal-stop-d3)
  (local-set-key [?\C-x ?\C-4] 'tidal-stop-d4)
  (local-set-key [?\C-x ?\C-5] 'tidal-stop-d5)
  (local-set-key [?\C-x ?\C-6] 'tidal-stop-d6)
  (local-set-key [?\C-x ?\C-7] 'tidal-stop-d7)
  (local-set-key [?\C-x ?\C-8] 'tidal-stop-d8)
  (local-set-key [?\C-x ?\C-9] 'tidal-stop-d9))
